...
namespace Game.Dialogues.NPC
{
    public class SecondFromChest : NPC, ITalkable
    {
        ...
        private void Awake()
        {
            ...
            {
                backgroundController.ChangeSpriteWithoutFade(withHatSprite);
            }
        }
        ...
        public override void Interact()
        {
            if (ProgressStorage.GetProgress(id) == 2 && Storage.isItemInSlots(AllItems.GetItemById(NeedItemId)))
            {
                ...
                backgroundController.ChangeSpriteWithFade(withHatSprite);
                return;
            }
